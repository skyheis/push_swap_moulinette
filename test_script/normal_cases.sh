...
#    Updated: 2023/06/30 23:23:42 by ggiannit         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
./push_swap 1 2 3 | ./ps_moulinette 1 2 3 >> results/with_3
./push_swap 1 3 2 | ./ps_moulinette 1 3 2 >> results/with_3
./push_swap 2 1 3 | ./ps_moulinette 2 1 3 >> results/with_3
./push_swap 2 3 1 | ./ps_moulinette 2 3 1 >> results/with_3
./push_swap 3 1 2 | ./ps_moulinette 3 1 2 >> results/with_3
./push_swap 3 2 1 | ./ps_moulinette 3 2 1 >> results/with_3
...
for run in {1..84}; do
	...
	./push_swap $ARG_5 | ./ps_moulinette $ARG_5 >> results/with_5
...
for run in {1..33}; do
	...
	./push_swap $ARG_100 | ./ps_moulinette $ARG_100 >> results/with_100
...
for run in {1..33}; do
	...
	./push_swap $ARG_500 | ./ps_moulinette $ARG_500 >> results/with_500
